...
"<br>\n");
        ...
        try
        {
            ...
            ResultSet rs=st.executeQuery("select answer from users where email=\""+email+"\";");
            ...
            {
                p.println("<form  action=\"forgot3\" method=\"post\" >\n" +
"<p><center>Email : &nbsp<input type=\"text\" name=\"email\" value=\""+email+"\" readonly></center></p><br><br>\n" +                        
...
"</form>\n");      
            ...
            else
            {
                ...
                p.println("<p><h3><center>Answer is incorrect. Try again </center></h3></p><br><br><br><br>\n" +
