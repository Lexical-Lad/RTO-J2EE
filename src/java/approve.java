    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response)
        ...
        try
        {
            ...
            for(int i=0;i<s.length;i++)
            {
                ...
                query="update users set apstatus='3',payment='0' where username='"+username+"';";
...
"<br><br><p><center><strong>The selected applications were approved and the respective applicants are notified of the test dates via email</strong></center></p><br><br>\n" +
