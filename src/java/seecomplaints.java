 ...
 * @author Samuel
 */
public class seecomplaints extends HttpServlet {
...
try
    {
        ...
        ResultSet rs=st.executeQuery("select id,message,status from complaints where status=\"0\";");
...
"  </div>\n" +
"<div id=\"content\">" +
"<br><br><br><br><br><br><p><h3><center>There are no complaints to Review, currently!</center></h3></p><br><br>\n" +
"</div>\n" +
"</div>\n" +
"\n" +
"<div id=\"footer\">\n" +
...
"<p><center><h2 style=\"color:#000000\"><strong>Complaints :</strong></h2></center></p><br><br>\n" +       
"<tr>\n" +
"<th>Complaint ID</th>\n" +
"<th>Complaint</th>\n" +
"<th>Reply</th>\n" +
"<th>Select</th>\n" +
"</tr>" +
"<form action=\"submitreplies\" method=\"post\">");       
        ...
        while(rs.next())
        {
            ...
            else
            {
                ...
                p.println("<tr>\n" +
                        "<td>"+id+"</td>\n" +
                        "<td>"+message+"</td>\n" +
                        "<td><input type=\"text\" name=\"reply\" maxlength=\"500\"></td>\n" +
                        "<td><button name=\"submit\" type=\"submit\" value=\""+id+"\">Submit</button></td>\n"  +
                        "</tr>");
            }
