...
"<br>\n");
        ...
        try
        {
            ...
            if(pass.equals(pass1))
            {
                ...
                p.println("<br><br><br><br><br><br><p><h3><center>The password has been changed successfully. Please login using the new password!</center></h3></p><br><br>\n");
            ...
            else
            {
                ...
                p.println("<p><h3><center>The passwords don't match. Try again! </center></h3></p><br><br><br><br>\n" +
"<form  action=\"forgot3\" method=\"post\" >\n" +
"<p><center>Email : &nbsp<input type=\"text\" name=\"email\" value=\""+email+"\" readonly></center></p><br><br><br>\n" +                        
"<p><center>New Password : &nbsp<input type=\"password\" name=\"pass\" required></center></p><br>\n" +
"<p><center>Confirm : &nbsp<input type=\"password\" name=\"pass1\" required></center></p><br>\n" +                        
