...
public class adminloginverification extends HttpServlet {
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response)
        ...
        if(hs.getAttribute("logged")!=null)
        {
         ...
         {
             hs.setAttribute("logged","*");
                
                RequestDispatcher rd=request.getRequestDispatcher("adminmenu");
...
"<div id=\"content\">\n" +
"<br><br>\n" +
"<center><h2 class=\"title\">ADMIN LOGIN</h2></center>\n" +
"<br>\n" +
"<p><center><div id=\"temp\" style=\"color:red\">Wrong Username/Password Combination</div></center></p><br><br>"   +                  
"<form name=\"login\" action=\"adminloginverification\" method=\"post\" >\n" +
