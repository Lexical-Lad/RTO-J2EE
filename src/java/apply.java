...
public class apply extends HttpServlet {
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response)
        ...
        try
        {
            ...
            apnumber=(new Integer(ran)).toString();
            ...
            while(true)
            {
                ...
                rs=st.executeQuery("select apnumber from users;");
                
                
                while(rs.next())
                {
                    if(rs.getString("apnumber")!=null && rs.getString("apnumber").equals(apnumber))
                    {
            ...
            query="update users set apstatus=\'1\',reap=NULL,payment=NULL,apnumber=\'"+apnumber+"\',lictype=\'"+lictype+"\' where username=\'"+username+"\';";
...
"<p><center><strong>Your application has been submitted! Check back regularly for updates!</strong></center></p><br><br>\n" +
"<p><center><strong><a href=\"usermenu\">Back</a></strong></center></p><br><br>"  +
"</div>\n" +
"</div>\n" +
"\n" +
"<div id=\"footer\">\n" +
